...
# Выполнить индивидуальное задание лабораторной работы 2.11, оформив
# все функции программы в виде отдельного модуля. Разработанный модуль
# должен быть подключен в основную программу с помощью одного из вариантов
# команды import . Номер варианта уточнить у преподавателя.
...
# Далее, на вход программы поступает две строки: первая с тегом, вторая с
...
from module_for_individual_task_1 import create_tagged_string
